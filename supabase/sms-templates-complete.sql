...
('RECEIVED', 'Hi {customer_name},

We''ve received your {device_make} {device_model}. We''ll assess it and get back to you shortly with a quote.
...
('PARTS_ORDERED', 'Hi {customer_name},

Parts for your {device_make} {device_model} have been ordered. We''ll notify you when they arrive and we''re ready to start the repair.
...
('IN_REPAIR', 'Hi {customer_name},

Your {device_make} {device_model} repair is now in progress. Our technicians are working on it and we''ll update you when it''s ready.
...
('CANCELLED', 'Hi {customer_name},

Your {device_make} {device_model} repair has been cancelled. If you have any questions, please contact us.
...
We''ve received your £{deposit_amount} deposit for {device_make} {device_model}. Parts are being ordered now.
...
('DELAY_NOTIFICATION', 'Hi {customer_name},

There''s a slight delay with your {device_make} {device_model} repair. We''ll keep you updated.
...
('QUOTE_REMINDER', 'Hi {customer_name},

Just a reminder about your {device_make} {device_model} repair quote of £{price_total}. Let us know if you''d like to proceed.
