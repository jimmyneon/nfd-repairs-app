-- Add AWAITING_CUSTOMER for jobs that are paused pending a customer decision/reply.
-- This is an internal workflow blocker. Changing to this status does NOT
-- automatically send an SMS or email, avoiding duplicate messages when staff
-- have already contacted the customer.
