...
import { CheckCircle, Loader2, AlertCircle, ArrowLeft, ArrowRight, MessageSquare, Mail, Clock, MapPin } from 'lucide-react'
...
export default function WalkInSelfBookingPage() {
  ...
  const issueOptions: Record<string, string[]> = {
    phone: ['Screen Replacement', 'Battery Replacement', 'Charging Port Service', 'Charging Port Replacement', 'Not Charging', 'Water Damage', 'No Power', 'Black Screen', 'Data Recovery', 'Software Issues', 'Other'],
    tablet: ['Screen Replacement', 'Battery Replacement', 'Charging Port Service', 'Charging Port Replacement', 'Not Charging', 'Water Damage', 'No Power', 'Black Screen', 'Software Issues', 'Other'],
  ...
  if (success) {
    const deviceSummary = formData.notSure
      ? 'Your device'
      : `${formData.deviceMake || ''} ${formData.deviceModel || ''}`.trim() || 'Your device'
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-50 to-white dark:from-gray-900 dark:to-gray-800">
        <main className="max-w-lg mx-auto px-4 py-8 space-y-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 text-center">
            ...
            {/* Device + customer summary */}
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 text-left space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-semibold text-gray-900 dark:text-white">{deviceSummary}</span>
              </div>
              {!formData.notSure && formData.issue && (
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500 dark:text-gray-400">Issue</span>
                  <span className="font-semibold text-gray-900 dark:text-white">{formData.issue}</span>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="space-y-3">
              ...
              {formData.customerEmail && (
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm text-gray-700 dark:text-gray-300"><strong>Also emailed</strong> to {formData.customerEmail} — you can check it there later.</p>
                </div>
              )}
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300"><strong>We&apos;ll assess your device</strong> and text you a quote for the repair.</p>
              </div>
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300"><strong>Collect when ready</strong> — we&apos;ll text you when your device is ready for collection.</p>
              </div>
            </div>
          </div>
